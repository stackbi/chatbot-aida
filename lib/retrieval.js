...
// Pas d'appel à une API d'embeddings externe : fonctionne uniquement avec la clé API Anthropic
// déjà configurée. Pour un site avec beaucoup de contenu (>200 pages), on peut plus tard
