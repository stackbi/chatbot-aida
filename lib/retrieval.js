...
export function buildContextBlock(relevantChunks) {
  ...
  return `\n\n« CONTEXTE OFFICIEL (OBLIGATOIRE) : toute réponse DOIT être basée sur les sources ci-dessous. N'invente AUCUN téléphone, email, prix ou adresse. »\n\n${parts.join("\n\n")}\n\nRAPPEL : si absent du contexte → ne pas inventer.`;
}
